     ...
     <div id="wrapper">
       ...
       <div id="page-wrapper">
         <div id="page-inner">
           ...
           <div class="form-group">
             <label>Data*</label>
             <input type="date" class="form-control" placeholder="Coloque a data do movimento"</label>
           </div>
              <div class="form-group">
             <label>Valor*</label>
             <input class="form-control" placeholder="Digite o valor do movimento"</label>
           </div>
         </div>
         <div class="col-md-6">
             <div class="form-group">
